...
El programa java que lo gestiona primero captura los datos XMLRP de ODOO, y con esos datos crea un fichero de datos bajo un root XMLRPC (por ejemplo el partner capturado lo incluyen en XMLRPC/MAP/partner_id), con ese XML de datos ejecuta la transformacion XSL, y despues el programa java que lo gestiona ejecuta el SQL y reemplaza los valores obtenidos por los marcadores de sintaxis {$campo}
